...
#[c2rust::src_loc = "7:1"]
unsafe extern "C" fn muteset_hash(mut actor: *mut pony_actor_t) -> usize {
...
#[no_mangle]
#[c2rust::src_loc = "17:1"]
pub unsafe extern "C" fn ponyint_muteset_alloc_size(mut map: *mut muteset_t) -> usize {
    ponyint_hashmap_alloc_size(map as *mut hashmap_t)
}
#[no_mangle]
#[c2rust::src_loc = "17:1"]
pub unsafe extern "C" fn ponyint_muteset_init(mut map: *mut muteset_t, mut size: usize) {
...
#[no_mangle]
#[c2rust::src_loc = "17:1"]
pub unsafe extern "C" fn ponyint_muteset_removeindex(mut map: *mut muteset_t, mut index: usize) {
    ponyint_hashmap_removeindex(map as *mut hashmap_t, index);
}
#[no_mangle]
#[c2rust::src_loc = "17:1"]
pub unsafe extern "C" fn ponyint_muteset_clearindex(mut map: *mut muteset_t, mut index: usize) {
    ponyint_hashmap_clearindex(map as *mut hashmap_t, index);
}
#[no_mangle]
#[c2rust::src_loc = "17:1"]
pub unsafe extern "C" fn ponyint_muteset_size(mut map: *mut muteset_t) -> usize {
...
#[no_mangle]
#[c2rust::src_loc = "17:1"]
pub unsafe extern "C" fn ponyint_muteset_mem_size(mut map: *mut muteset_t) -> usize {
...
#[c2rust::src_loc = "20:1"]
unsafe extern "C" fn muteref_hash(mut mref: *mut muteref_t) -> usize {
...
pub unsafe extern "C" fn ponyint_muteref_alloc(mut key: *mut pony_actor_t) -> *mut muteref_t {
    let mut mref: *mut muteref_t = ponyint_pool_alloc(1 as libc::c_int as usize) as *mut muteref_t;
    memset(
...
pub unsafe extern "C" fn ponyint_muteref_free(mut mref: *mut muteref_t) {
    ...
    ponyint_pool_free(1 as libc::c_int as usize, mref as *mut libc::c_void);
}
#[no_mangle]
#[c2rust::src_loc = "45:1"]
...
#[no_mangle]
#[c2rust::src_loc = "45:1"]
pub unsafe extern "C" fn ponyint_mutemap_removeindex(mut map: *mut mutemap_t, mut index: usize) {
    ponyint_hashmap_removeindex(map as *mut hashmap_t, index);
}
#[no_mangle]
#[c2rust::src_loc = "45:1"]
pub unsafe extern "C" fn ponyint_mutemap_mem_size(mut map: *mut mutemap_t) -> usize {
    ponyint_hashmap_mem_size(map as *mut hashmap_t)
}
#[no_mangle]
#[c2rust::src_loc = "45:1"]
pub unsafe extern "C" fn ponyint_mutemap_clearindex(mut map: *mut mutemap_t, mut index: usize) {
    ponyint_hashmap_clearindex(map as *mut hashmap_t, index);
}
#[no_mangle]
#[c2rust::src_loc = "45:1"]
...
#[no_mangle]
#[c2rust::src_loc = "45:1"]
pub unsafe extern "C" fn ponyint_mutemap_size(mut map: *mut mutemap_t) -> usize {
    ponyint_hashmap_size(map as *mut hashmap_t)
}
#[no_mangle]
#[c2rust::src_loc = "45:1"]
pub unsafe extern "C" fn ponyint_mutemap_init(mut map: *mut mutemap_t, mut size: usize) {
    ponyint_hashmap_init(map as *mut hashmap_t, size);
}
#[no_mangle]
#[c2rust::src_loc = "45:1"]
pub unsafe extern "C" fn ponyint_mutemap_alloc_size(mut map: *mut mutemap_t) -> usize {
    ponyint_hashmap_alloc_size(map as *mut hashmap_t)
}
#[no_mangle]
#[c2rust::src_loc = "45:1"]
...
pub unsafe extern "C" fn ponyint_mutemap_next(
    ...
    let mut h: *mut hashmap_t = map as *mut hashmap_t;
    ponyint_hashmap_next(i, (*h).count, (*h).item_bitmap, (*h).size, (*h).buckets) as *mut muteref_t
}
#[no_mangle]
#[c2rust::src_loc = "45:44"]
