...
pub mod ast_h {
    ...
    extern "C" {
        ...
        #[c2rust::src_loc = "83:1"]
        pub fn ast_setsend(ast: *mut ast_t);
        #[c2rust::src_loc = "85:1"]
        pub fn ast_setmightsend(ast: *mut ast_t);
        #[c2rust::src_loc = "87:1"]
...
pub mod package_h {
    ...
    extern "C" {
        ...
        pub fn package_allow_ffi(t: *mut typecheck_t) -> bool;
    }
}
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/type/lookup.h:4"]
pub mod lookup_h {
...
pub use self::ast_h::{
    ast_child, ast_childidx, ast_data, ast_error, ast_error_continue, ast_get_children, ast_id,
...
use self::package_h::package_allow_ffi;
pub use self::pass_h::{
...
#[c2rust::src_loc = "8:1"]
unsafe extern "C" fn check_partial_function_call(
        ...
        || ast_id(ast) as libc::c_uint == TK_NEWREF as libc::c_int as libc::c_uint
    {
        ...
        ponyint_assert_fail(
            ...
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/verify/call.c\0"
                as *const u8 as *const libc::c_char,
            11 as libc::c_int as size_t,
            (*::core::mem::transmute::<
                &[u8; 28],
                &[libc::c_char; 28],
            >(b"check_partial_function_call\0"))
                .as_ptr(),
        );
    };
    ...
    if ast_id(call) as libc::c_uint == TK_ADDRESS as libc::c_int as libc::c_uint {
    ...
    if ast_id(call) as libc::c_uint == TK_CALL as libc::c_int as libc::c_uint {
        ...
        ponyint_assert_fail(
            b"ast_id(call) == TK_CALL\0" as *const u8 as *const libc::c_char,
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/verify/call.c\0" as *const u8
    ...
    let mut call_error: *mut ast_t = ast_childidx(call, 3 as libc::c_int as size_t);
    if ast_id(call_error) as libc::c_uint == TK_QUESTION as libc::c_int as libc::c_uint
        || ast_id(call_error) as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint
        || ast_id(call_error) as libc::c_uint == TK_DONTCARE as libc::c_int as libc::c_uint
    {
    } else {
        ponyint_assert_fail(
            b"ast_id(call_error) == TK_QUESTION || ast_id(call_error) == TK_NONE || ast_id(call_error) == TK_DONTCARE\0"
                as *const u8 as *const libc::c_char,
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/verify/call.c\0"
                as *const u8 as *const libc::c_char,
    ...
    let mut skip_partial_check: bool = 0 as libc::c_int != 0;
    if !(ast_child(receiver)).is_null()
        && ast_id(ast_child(receiver)) as libc::c_uint == TK_ID as libc::c_int as libc::c_uint
        && is_name_internal_test(ast_name(ast_child(receiver))) as libc::c_int != 0
    {
        skip_partial_check = 1 as libc::c_int != 0;
    }
    let mut body_donor: *mut ast_t = ast_data((*(*opt).check.frame).method) as *mut ast_t;
    if !body_donor.is_null()
        && ast_id(body_donor) as libc::c_uint == TK_TRAIT as libc::c_int as libc::c_uint
    {
        skip_partial_check = 1 as libc::c_int != 0;
    }
    let mut r: bool = 1 as libc::c_int != 0;
    let mut method_error: *mut ast_t = ast_childidx(method_ast, 5 as libc::c_int as size_t);
    if ast_id(method_error) as libc::c_uint == TK_QUESTION as libc::c_int as libc::c_uint {
        ast_seterror(ast);
        if ast_id(call_error) as libc::c_uint != TK_QUESTION as libc::c_int as libc::c_uint
            && !skip_partial_check
        {
            ast_error(
                (*opt).check.errors,
                call_error,
                b"call is not partial but the method is - a question mark is required after this call\0"
                    as *const u8 as *const libc::c_char,
            );
            ast_error_continue(
                (*opt).check.errors,
                method_error,
                b"method is here\0" as *const u8 as *const libc::c_char,
            );
            r = 0 as libc::c_int != 0;
        }
    } else if ast_id(call_error) as libc::c_uint == TK_QUESTION as libc::c_int as libc::c_uint
        && !skip_partial_check
    {
        ast_error(
            (*opt).check.errors,
            call_error,
            b"call is partial but the method is not - this question mark should be removed\0"
                as *const u8 as *const libc::c_char,
        );
        ast_error_continue(
            (*opt).check.errors,
...
#[c2rust::src_loc = "83:1"]
unsafe extern "C" fn check_partial_ffi_call(mut opt: *mut pass_opt_t, mut ast: *mut ast_t) -> bool {
    if ast_id(ast) as libc::c_uint == TK_FFICALL as libc::c_int as libc::c_uint {
        ...
        ponyint_assert_fail(
            ...
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/verify/call.c\0" as *const u8
                as *const libc::c_char,
            85 as libc::c_int as size_t,
            (*::core::mem::transmute::<&[u8; 23], &[libc::c_char; 23]>(
                b"check_partial_ffi_call\0",
            ))
            .as_ptr(),
        );
    };
    let mut call_name: ast_ptr_t = 0 as *mut ast_t;
    let mut call_ret_typeargs: ast_ptr_t = 0 as *mut ast_t;
    let mut args: ast_ptr_t = 0 as *mut ast_t;
    let mut named_args: ast_ptr_t = 0 as *mut ast_t;
    let mut call_error: ast_ptr_t = 0 as *mut ast_t;
    let mut children: [*mut *mut ast_t; 6] = [
        &mut call_name,
        &mut call_ret_typeargs,
        &mut args,
        &mut named_args,
        &mut call_error,
        0 as *mut *mut ast_t,
    ...
    if decl.is_null() {
        ...
        if ast_id(decl) as libc::c_uint == TK_FFIDECL as libc::c_int as libc::c_uint {
            ...
            ponyint_assert_fail(
                b"ast_id(decl) == TK_FFIDECL\0" as *const u8 as *const libc::c_char,
                b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/verify/call.c\0"
                    as *const u8 as *const libc::c_char,
        ...
        if ast_id(decl_error) as libc::c_uint == TK_QUESTION as libc::c_int as libc::c_uint {
            ...
            if ast_id(call_error) as libc::c_uint != TK_QUESTION as libc::c_int as libc::c_uint {
                ast_error(
                    (*opt).check.errors,
                    call_error,
                    b"call is not partial but the declaration is - a question mark is required after this call\0"
                        as *const u8 as *const libc::c_char,
                );
                ast_error_continue(
                    (*opt).check.errors,
                    decl_error,
                    b"declaration is here\0" as *const u8 as *const libc::c_char,
                );
            ...
            ast_error(
                (*opt).check.errors,
                call_error,
                b"call is partial but the declaration is not - this question mark should be removed\0"
                    as *const u8 as *const libc::c_char,
            );
            ast_error_continue(
                (*opt).check.errors,
...
pub unsafe extern "C" fn verify_function_call(
    mut opt: *mut pass_opt_t,
    mut ast: *mut ast_t,
) -> bool {
    if ast_id(ast) as libc::c_uint == TK_FUNREF as libc::c_int as libc::c_uint
        ...
        || ast_id(ast) as libc::c_uint == TK_NEWREF as libc::c_int as libc::c_uint
    {
        ...
        ponyint_assert_fail(
            ...
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/verify/call.c\0"
                as *const u8 as *const libc::c_char,
            130 as libc::c_int as size_t,
            (*::core::mem::transmute::<
                &[u8; 21],
                &[libc::c_char; 21],
            >(b"verify_function_call\0"))
                .as_ptr(),
        );
    };
...
pub unsafe extern "C" fn verify_behaviour_call(
    ...
    if ast_id(ast) as libc::c_uint == TK_BEREF as libc::c_int as libc::c_uint
        || ast_id(ast) as libc::c_uint == TK_BECHAIN as libc::c_int as libc::c_uint
        || ast_id(ast) as libc::c_uint == TK_NEWBEREF as libc::c_int as libc::c_uint
    {
    } else {
        ponyint_assert_fail(
            b"(ast_id(ast) == TK_BEREF) || (ast_id(ast) == TK_BECHAIN) || (ast_id(ast) == TK_NEWBEREF)\0"
                as *const u8 as *const libc::c_char,
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/verify/call.c\0"
                as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn verify_ffi_call(mut opt: *mut pass_opt_t, mut ast: *mut ast_t) -> bool {
    if ast_id(ast) as libc::c_uint == TK_FFICALL as libc::c_int as libc::c_uint {
    } else {
        ponyint_assert_fail(
            b"ast_id(ast) == TK_FFICALL\0" as *const u8 as *const libc::c_char,
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/verify/call.c\0" as *const u8
                as *const libc::c_char,
            155 as libc::c_int as size_t,
            (*::core::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"verify_ffi_call\0"))
                .as_ptr(),
        );
    };
    if !package_allow_ffi(&mut (*opt).check) {
        ast_error(
            (*opt).check.errors,
            ast,
            b"this package isn't allowed to do C FFI\0" as *const u8 as *const libc::c_char,
        );
        return 0 as libc::c_int != 0;
    }
    ast_inheritflags(ast);
