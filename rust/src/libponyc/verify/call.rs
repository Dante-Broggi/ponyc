...
unsafe extern "C" fn check_partial_function_call(
    ...
    let mut call_error: *mut ast_t = ast_childidx(call, 3 as libc::c_int as usize);
    ...
    let mut method_error: *mut ast_t = ast_childidx(method_ast, 5 as libc::c_int as usize);
