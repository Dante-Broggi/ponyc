...
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/codegen/codegen.h:3"]
pub mod codegen_h {
    use super::pass_h::pass_opt_t;
    extern "C" {
        #[c2rust::src_loc = "235:1"]
        pub fn codegen_pass_cleanup(opt: *mut pass_opt_t);
        #[c2rust::src_loc = "231:1"]
        pub fn codegen_llvm_shutdown();
        #[c2rust::src_loc = "233:1"]
        pub fn codegen_pass_init(opt: *mut pass_opt_t) -> bool;
        #[c2rust::src_loc = "229:1"]
        pub fn codegen_llvm_init() -> bool;
    }
}
...
pub mod package_h {
    ...
    extern "C" {
        #[c2rust::src_loc = "39:1"]
        pub fn package_init(opt: *mut pass_opt_t) -> bool;
        #[c2rust::src_loc = "188:1"]
        pub fn package_done(opt: *mut pass_opt_t);
    }
}
...
#[no_mangle]
#[c2rust::src_loc = "20:1"]
pub unsafe extern "C" fn ponyc_shutdown(mut options: *mut pass_opt_t) {
