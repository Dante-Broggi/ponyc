...
pub mod gencall_h {
    ...
    extern "C" {
        #[c2rust::src_loc = "28:1"]
        pub fn gencall_allocstruct(c: *mut compile_t, t: *mut reach_type_t) -> LLVMValueRef;
    }
}
...
pub use self::Core_h::{
    ...
    LLVMCommonLinkage, LLVMDLLExportLinkage, LLVMDLLImportLinkage, LLVMDoubleTypeKind,
    LLVMExternalLinkage, LLVMExternalWeakLinkage, LLVMFP128TypeKind, LLVMFastCallConv,
    LLVMFloatTypeKind, LLVMFunctionTypeKind, LLVMGHCCallConv, LLVMGetTypeKind, LLVMGhostLinkage,
    LLVMHHVMCCallConv, LLVMHHVMCallConv, LLVMHalfTypeKind, LLVMHiPECallConv, LLVMIntegerTypeKind,
    ...
    LLVMPointerTypeKind, LLVMPreserveAllCallConv, LLVMPreserveMostCallConv, LLVMPrivateLinkage,
    LLVMSPIRFUNCCallConv, LLVMSPIRKERNELCallConv, LLVMScalableVectorTypeKind, LLVMStructTypeKind,
...
#[no_mangle]
#[c2rust::src_loc = "9:1"]
pub unsafe extern "C" fn gen_box(
    mut c: *mut compile_t,
    mut type_0: *mut ast_t,
    mut value: LLVMValueRef,
) -> LLVMValueRef {
    let mut l_type: LLVMTypeRef = LLVMTypeOf(value);
    if LLVMGetTypeKind(l_type) as libc::c_uint == LLVMPointerTypeKind as libc::c_int as libc::c_uint
    {
        return value;
    }
    ...
    if !t.is_null() {
        ...
        ponyint_assert_fail(
            ...
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/codegen/genbox.c\0"
                as *const u8 as *const libc::c_char,
            17 as libc::c_int as size_t,
            (*::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"gen_box\0")).as_ptr(),
        );
    };
    ...
    let mut this_ptr: LLVMValueRef = gencall_allocstruct(c, t);
    let mut value_ptr: LLVMValueRef = LLVMBuildStructGEP_P(
        (*c).builder,
        this_ptr,
...
#[no_mangle]
#[c2rust::src_loc = "35:1"]
pub unsafe extern "C" fn gen_unbox(
    mut c: *mut compile_t,
    mut type_0: *mut ast_t,
    mut object: LLVMValueRef,
) -> LLVMValueRef {
    let mut l_type: LLVMTypeRef = LLVMTypeOf(object);
    if LLVMGetTypeKind(l_type) as libc::c_uint != LLVMPointerTypeKind as libc::c_int as libc::c_uint
    {
        return object;
    }
    ...
    if !t.is_null() {
        ...
        ponyint_assert_fail(
            ...
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/codegen/genbox.c\0"
                as *const u8 as *const libc::c_char,
            43 as libc::c_int as size_t,
            (*::core::mem::transmute::<&[u8; 10], &[libc::c_char; 10]>(b"gen_unbox\0")).as_ptr(),
        );
    };
    let mut c_t: *mut compile_type_t = (*t).c_type as *mut compile_type_t;
    ...
    let mut this_ptr: LLVMValueRef = LLVMBuildBitCast(
        (*c).builder,
        object,
        (*c_t).structure_ptr,
        b"\0" as *const u8 as *const libc::c_char,
