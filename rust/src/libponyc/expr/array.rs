...
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/expr/call.h:2"]
pub mod call_h {
...
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/expr/control.h:3"]
pub mod control_h {
    use super::pass_h::pass_opt_t;
    use super::symtab_h::ast_t;
    extern "C" {
...
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/expr/literal.h:4"]
pub mod literal_h {
    use super::pass_h::pass_opt_t;
    use super::symtab_h::ast_t;
    extern "C" {
...
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/expr/reference.h:6"]
pub mod reference_h {
    use super::pass_h::pass_opt_t;
    use super::symtab_h::ast_t;
    extern "C" {
...
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/pass/refer.h:11"]
pub mod refer_h {
    use super::pass_h::pass_opt_t;
    use super::symtab_h::ast_t;
    extern "C" {
        #[c2rust::src_loc = "11:1"]
        pub fn refer_reference(opt: *mut pass_opt_t, astp: *mut *mut ast_t) -> bool;
        #[c2rust::src_loc = "13:1"]
        pub fn refer_qualify(opt: *mut pass_opt_t, ast: *mut ast_t) -> bool;
    }
}
...
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/type/subtype.h:15"]
pub mod subtype_h {
...
pub use self::ast_h::{
    ...
    ast_data, ast_dup, ast_error, ast_error_frame, ast_free_unattached, ast_from, ast_from_int,
    ast_from_string, ast_get, ast_get_children, ast_id, ast_inheritflags, ast_name, ast_parent,
    ast_print_type, ast_ptr_t, ast_replace, ast_result_t, ast_scope, ast_setid, ast_settype,
    ast_sibling, ast_swap, ast_type, astlist_data, astlist_free, astlist_length, astlist_next,
    astlist_push, astlist_t, C2RustUnnamed, AST_ERROR, AST_FATAL, AST_FLAG_AMBIGUOUS,
...
use self::expr_h::{find_antecedent_type, is_typecheck_error, pass_expr, pass_pre_expr};
...
use self::postfix_h::{expr_chain, expr_dot};
...
#[c2rust::src_loc = "19:1"]
unsafe extern "C" fn build_array_type(
    mut opt: *mut pass_opt_t,
    mut scope: *mut ast_t,
    mut elem_type: *mut ast_t,
    mut cap: token_id,
    mut eph: token_id,
) -> *mut ast_t {
    elem_type = ast_dup(elem_type);
    let mut typeargs: *mut ast_t = 0 as *mut ast_t;
    let mut basis_ast: *mut ast_t = elem_type;
    ...
    if parent_0.is_null() {
        ...
        last_sibling_0 = ast_add(parent_0, elem_type);
    } else {
        last_sibling_0 = ast_add_sibling(last_sibling_0, elem_type);
    }
    ast_inheritflags(parent_0);
    typeargs = parent;
    let mut array_type: *mut ast_t = type_builtin_args(
        opt,
        scope,
...
#[c2rust::src_loc = "34:1"]
unsafe extern "C" fn strip_this_arrow(mut opt: *mut pass_opt_t, mut ast: *mut ast_t) -> *mut ast_t {
...
#[c2rust::src_loc = "53:1"]
unsafe extern "C" fn detect_apply_element_type(
    mut opt: *mut pass_opt_t,
    mut ast: *mut ast_t,
    mut def: *mut ast_t,
) -> *mut ast_t {
    let mut apply: *mut ast_t = ast_get(
        def,
        stringtab(b"apply\0" as *const u8 as *const libc::c_char),
        0 as *mut sym_status_t,
    );
    if apply.is_null() || ast_id(apply) as libc::c_uint != TK_FUN as libc::c_int as libc::c_uint {
...
#[c2rust::src_loc = "85:1"]
unsafe extern "C" fn detect_values_element_type(
    mut opt: *mut pass_opt_t,
    mut ast: *mut ast_t,
    mut def: *mut ast_t,
) -> *mut ast_t {
    let mut values: *mut ast_t = ast_get(
        def,
        stringtab(b"values\0" as *const u8 as *const libc::c_char),
        0 as *mut sym_status_t,
    );
    if values.is_null() || ast_id(values) as libc::c_uint != TK_FUN as libc::c_int as libc::c_uint {
        return 0 as *mut ast_t;
    }
    let mut receiver_cap: ast_ptr_t = 0 as *mut ast_t;
    let mut apply_name: ast_ptr_t = 0 as *mut ast_t;
    ...
    if ast_id(elem_type) as libc::c_uint == TK_ARROW as libc::c_int as libc::c_uint
...
#[c2rust::src_loc = "122:1"]
unsafe extern "C" fn find_possible_element_types(
    mut opt: *mut pass_opt_t,
    mut ast: *mut ast_t,
    mut list: *mut *mut astlist_t,
) {
    match ast_id(ast) as libc::c_uint {
        151 => {
            ...
            let mut elem_type: *mut ast_t = detect_apply_element_type(opt, ast, def);
            ...
            let mut array_type: *mut ast_t =
                build_array_type(opt, ast, elem_type, TK_ISO, TK_EPHEMERAL);
            if !is_subtype(array_type, ast, 0 as *mut errorframe_t, opt) {
        ...
        17 => {
            find_possible_element_types(opt, ast_childidx(ast, 1 as libc::c_int as size_t), list);
            return;
        }
        187 => {
            ...
            find_possible_element_types(opt, ast_childidx(def_0, 1 as libc::c_int as size_t), list);
            return;
        }
        149 | 56 => {
            let mut c: *mut ast_t = ast_child(ast);
...
unsafe extern "C" fn find_possible_iterator_element_types(
    mut opt: *mut pass_opt_t,
    mut ast: *mut ast_t,
    mut list: *mut *mut astlist_t,
) {
...
unsafe extern "C" fn infer_element_type(
    mut opt: *mut pass_opt_t,
    mut ast: *mut ast_t,
    mut type_spec_p: *mut *mut ast_t,
    mut antecedent_type: *mut ast_t,
) -> bool {
    let mut possible_element_types: *mut astlist_t = 0 as *mut astlist_t;
    if !antecedent_type.is_null() {
        find_possible_element_types(opt, antecedent_type, &mut possible_element_types);
    } else if ast_id(ast_parent(ast)) as libc::c_uint == TK_DOT as libc::c_int as libc::c_uint
        && ast_name(ast_sibling(ast)) == stringtab(b"values\0" as *const u8 as *const libc::c_char)
    {
        let mut dot: *mut ast_t = ast_parent(ast);
        antecedent_type = find_antecedent_type(opt, dot, 0 as *mut bool);
        if !antecedent_type.is_null() {
    ...
    if astlist_length(possible_element_types) > 1 as libc::c_int as libc::c_ulong {
        ...
        while !left_cursor.is_null() {
            let mut eqtype_of_any_remaining: bool = 0 as libc::c_int != 0;
            let mut right_cursor: *mut astlist_t = astlist_next(left_cursor);
            while !right_cursor.is_null() {
                let mut left: *mut ast_t = astlist_data(left_cursor);
                let mut right: *mut ast_t = astlist_data(right_cursor);
                if right_cursor == left_cursor
                    || is_eqtype(right, left, 0 as *mut errorframe_t, opt) as libc::c_int != 0
                {
                    eqtype_of_any_remaining = 1 as libc::c_int != 0;
                }
                right_cursor = astlist_next(right_cursor);
            }
            if !eqtype_of_any_remaining {
                new_list = astlist_push(new_list, astlist_data(left_cursor));
            }
            left_cursor = astlist_next(left_cursor);
        }
    ...
    if astlist_length(possible_element_types) > 1 as libc::c_int as libc::c_ulong {
        ...
        while !super_cursor.is_null() {
            let mut supertype_of_any: bool = 0 as libc::c_int != 0;
            let mut sub_cursor: *mut astlist_t = possible_element_types;
            while !sub_cursor.is_null() {
                if sub_cursor != super_cursor
                    && is_subtype(
                        astlist_data(sub_cursor),
                        astlist_data(super_cursor),
                        0 as *mut errorframe_t,
                        opt,
                    ) as libc::c_int
                        != 0
                {
                    supertype_of_any = 1 as libc::c_int != 0;
                }
                sub_cursor = astlist_next(sub_cursor);
            }
            if !supertype_of_any {
                new_list_0 = astlist_push(new_list_0, astlist_data(super_cursor));
            }
            super_cursor = astlist_next(super_cursor);
        }
        astlist_free(possible_element_types);
    ...
    if astlist_length(possible_element_types) > 1 as libc::c_int as libc::c_ulong {
        ...
        while !cursor.is_null() {
            ...
            while !elem.is_null() {
                ...
                let mut elem_type: *mut ast_t = ast_type(elem);
                if is_typecheck_error(elem_type) as libc::c_int != 0
                    || ast_id(elem_type) as libc::c_uint
                        == TK_LITERAL as libc::c_int as libc::c_uint
                {
                    break;
                }
                if !cursor_type.is_null()
                    && !is_subtype(elem_type, cursor_type, 0 as *mut errorframe_t, opt)
                {
                    supertype_of_all = 0 as libc::c_int != 0;
                }
                elem = ast_sibling(elem);
            }
            if supertype_of_all {
                new_list_1 = astlist_push(new_list_1, astlist_data(cursor));
            }
            ast_free_unattached(cursor_type);
            cursor = astlist_next(cursor);
        }
        astlist_free(possible_element_types);
...
pub unsafe extern "C" fn expr_pre_array(
    mut opt: *mut pass_opt_t,
    mut astp: *mut *mut ast_t,
) -> ast_result_t {
    let mut ast: *mut ast_t = *astp;
    if ast_id(ast) as libc::c_uint == TK_ARRAY as libc::c_int as libc::c_uint {
    } else {
        ponyint_assert_fail(
    ...
    let mut type_spec: ast_ptr_t = 0 as *mut ast_t;
    let mut elements: ast_ptr_t = 0 as *mut ast_t;
    let mut children: [*mut *mut ast_t; 3] = [&mut type_spec, &mut elements, 0 as *mut *mut ast_t];
    ast_get_children(
        ast,
    ...
    let mut antecedent_type: *mut ast_t = find_antecedent_type(opt, ast, &mut is_recovered);
    if ast_id(type_spec) as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint {
        if !infer_element_type(opt, ast, &mut type_spec, antecedent_type) {
            return AST_ERROR;
        }
    }
    if ast_id(type_spec) as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint {
    ...
    let mut array_type: *mut ast_t = build_array_type(opt, ast, type_spec, TK_REF, TK_NONE);
    if !antecedent_type.is_null()
        && !is_recovered
        && !is_subtype(array_type, antecedent_type, 0 as *mut errorframe_t, opt)
        && is_subtype_ignore_cap(array_type, antecedent_type, 0 as *mut errorframe_t, opt)
            as libc::c_int
            != 0
    {
        ast_free_unattached(array_type);
        let mut recover: *mut ast_t = 0 as *mut ast_t;
        let mut basis_ast: *mut ast_t = ast;
        let mut parent: *mut ast_t = 0 as *mut ast_t;
        let mut last_sibling: *mut ast_t = 0 as *mut ast_t;
        let mut node: *mut ast_t = 0 as *mut ast_t;
        node = ast_from(basis_ast, TK_RECOVER);
        if parent.is_null() {
            parent = node;
        } else if last_sibling.is_null() {
            last_sibling = ast_add(parent, node);
        ...
        let mut last_sibling_0: *mut ast_t = 0 as *mut ast_t;
        let mut node_0: *mut ast_t = 0 as *mut ast_t;
        node_0 = ast_from(basis_ast, TK_ISO);
        if parent_0.is_null() {
            parent_0 = node_0;
        } else if last_sibling_0.is_null() {
        ...
        if parent_2.is_null() {
            ...
            last_sibling_2 = ast_add(parent_2, ast);
        } else {
            last_sibling_2 = ast_add_sibling(last_sibling_2, ast);
        }
        ...
        if ast_visit(
            ...
            Some(
                pass_expr as unsafe extern "C" fn(*mut *mut ast_t, *mut pass_opt_t) -> ast_result_t,
            ),
            opt,
            PASS_EXPR,
        ) as libc::c_uint
...
pub unsafe extern "C" fn expr_array(mut opt: *mut pass_opt_t, mut astp: *mut *mut ast_t) -> bool {
    let mut ast: *mut ast_t = *astp;
    let mut type_0: *mut ast_t = 0 as *mut ast_t;
    let mut told_type: bool = 0 as libc::c_int != 0;
    if ast_id(ast) as libc::c_uint == TK_ARRAY as libc::c_int as libc::c_uint {
    } else {
        ponyint_assert_fail(
            b"ast_id(ast) == TK_ARRAY\0" as *const u8 as *const libc::c_char,
    ...
    if !told_type && size == 0 as libc::c_int as libc::c_ulong {
        ast_error(
            (*opt).check.errors,
            ast,
            b"an empty array literal must specify the element type or it must be inferable from context\0"
                as *const u8 as *const libc::c_char,
        );
        return 0 as libc::c_int != 0;
    }
    ...
    while !ele.is_null() {
        if ast_checkflag(ele, AST_FLAG_JUMPS_AWAY as libc::c_int as uint32_t) != 0 {
            ast_error(
                (*opt).check.errors,
                ele,
                b"an array can't contain an expression that jumps away with no value\0" as *const u8
                    as *const libc::c_char,
            );
            ast_free_unattached(type_0);
            return 0 as libc::c_int != 0;
        }
        let mut c_type: *mut ast_t = ast_type(ele);
        if is_typecheck_error(c_type) {
            return 0 as libc::c_int != 0;
        }
        if told_type {
            if !coerce_literals(&mut ele, type_0, opt) {
                return 0 as libc::c_int != 0;
            }
            c_type = ast_type(ele);
            let mut w_type: *mut ast_t = consume_type(type_0, TK_NONE, 0 as libc::c_int != 0);
            ...
            if w_type.is_null() {
                ast_error_frame(
                    ...
                    ele,
                    b"invalid specified array element type: %s\0" as *const u8
                        as *const libc::c_char,
                ...
                if !is_subtype(c_type, w_type, &mut info, opt) {
                    ast_error_frame(
                        &mut frame as *mut errorframe_t,
                        ele,
                        b"array element not a subtype of specified array type\0" as *const u8
                            as *const libc::c_char,
                    );
                    ast_error_frame(
                        &mut frame as *mut errorframe_t,
                        type_spec,
                        b"array type: %s\0" as *const u8 as *const libc::c_char,
                        ast_print_type(type_0),
                    );
                    ast_error_frame(
                        &mut frame as *mut errorframe_t,
                        c_type,
                        b"element type: %s\0" as *const u8 as *const libc::c_char,
            ...
            type_0 = type_union(opt, type_0, c_type);
        }
        ele = ast_sibling(ele);
    }
    if !told_type {
        let mut aliasable_type: *mut ast_t = type_0;
        type_0 = alias(aliasable_type);
    ...
    if parent_0.is_null() {
        ...
        last_sibling_0 = ast_add(
            parent_0,
            ast_from_string(basis_ast, b"Array\0" as *const u8 as *const libc::c_char),
        );
    } else {
    ...
    ast_inheritflags(parent_0);
    ref_0 = parent;
    let mut qualify: *mut ast_t = 0 as *mut ast_t;
    let mut basis_ast_0: *mut ast_t = ast;
    let mut parent_1: *mut ast_t = 0 as *mut ast_t;
    let mut last_sibling_1: *mut ast_t = 0 as *mut ast_t;
    let mut node_1: *mut ast_t = 0 as *mut ast_t;
    node_1 = ast_from(basis_ast_0, TK_QUALIFY);
    if parent_1.is_null() {
        parent_1 = node_1;
    ...
    if parent_2.is_null() {
        ...
        last_sibling_2 = ast_add(parent_2, ref_0);
    } else {
        last_sibling_2 = ast_add_sibling(last_sibling_2, ref_0);
    }
    node_2 = ast_from(basis_ast_0, TK_TYPEARGS);
    if parent_2.is_null() {
        parent_2 = node_2;
    } else if last_sibling_2.is_null() {
    ...
    if parent_3.is_null() {
        ...
        last_sibling_3 = ast_add(parent_3, type_0);
    } else {
        last_sibling_3 = ast_add_sibling(last_sibling_3, type_0);
    }
    ast_inheritflags(parent_3);
    ast_inheritflags(parent_2);
    qualify = parent_1;
    let mut dot: *mut ast_t = 0 as *mut ast_t;
    ...
    if parent_5.is_null() {
        ...
        last_sibling_5 = ast_add(parent_5, qualify);
    } else {
        last_sibling_5 = ast_add_sibling(last_sibling_5, qualify);
    }
    if parent_5.is_null() {
        parent_5 = ast_from_string(basis_ast_1, b"create\0" as *const u8 as *const libc::c_char);
    } else if last_sibling_5.is_null() {
        last_sibling_5 = ast_add(
            parent_5,
            ast_from_string(basis_ast_1, b"create\0" as *const u8 as *const libc::c_char),
        );
    } else {
    ...
    node_6 = ast_from(basis_ast_2, TK_SEQ);
    if parent_6.is_null() {
        parent_6 = node_6;
    ...
    if parent_7.is_null() {
        ...
        last_sibling_7 = ast_add(parent_7, size_arg);
    } else {
        last_sibling_7 = ast_add_sibling(last_sibling_7, size_arg);
    }
    ast_inheritflags(parent_7);
    size_arg_seq = parent_6;
    ast_settype(
        size_arg,
        type_builtin(opt, ast, b"USize\0" as *const u8 as *const libc::c_char),
    );
    ast_settype(
        size_arg_seq,
        type_builtin(opt, ast, b"USize\0" as *const u8 as *const libc::c_char),
    ...
    node_8 = ast_from(basis_ast_3, TK_CALL);
    if parent_8.is_null() {
        parent_8 = node_8;
    ...
    if parent_9.is_null() {
        ...
        last_sibling_9 = ast_add(parent_9, dot);
    } else {
        last_sibling_9 = ast_add_sibling(last_sibling_9, dot);
    }
    node_9 = ast_from(basis_ast_3, TK_POSITIONALARGS);
    if parent_9.is_null() {
        parent_9 = node_9;
    } else if last_sibling_9.is_null() {
    ...
    if parent_10.is_null() {
        ...
        last_sibling_10 = ast_add(parent_10, size_arg_seq);
    } else {
        last_sibling_10 = ast_add_sibling(last_sibling_10, size_arg_seq);
    }
    ast_inheritflags(parent_10);
    if parent_9.is_null() {
        parent_9 = ast_from(basis_ast_3, TK_NONE);
    } else if last_sibling_9.is_null() {
        last_sibling_9 = ast_add(parent_9, ast_from(basis_ast_3, TK_NONE));
    } else {
        last_sibling_9 = ast_add_sibling(last_sibling_9, ast_from(basis_ast_3, TK_NONE));
    }
    if parent_9.is_null() {
        parent_9 = ast_from(basis_ast_3, TK_NONE);
    } else if last_sibling_9.is_null() {
    ...
    call = parent_8;
    if !refer_reference(opt, &mut ref_0)
        || !refer_qualify(opt, qualify)
        || !expr_typeref(opt, &mut qualify)
        || !expr_dot(opt, &mut dot)
        || !expr_call(opt, &mut call)
    {
        return 0 as libc::c_int != 0;
    }
    ast_swap(ast, call);
    *astp = call;
    ...
    while !ele_0.is_null() {
        ...
        let mut basis_ast_4: *mut ast_t = ast;
        ...
        node_11 = ast_from(basis_ast_4, TK_CHAIN);
        ...
        if parent_12.is_null() {
            ...
            last_sibling_12 = ast_add(parent_12, *astp);
        } else {
            last_sibling_12 = ast_add_sibling(last_sibling_12, *astp);
        }
        if parent_12.is_null() {
            parent_12 = ast_from_string(basis_ast_4, b"push\0" as *const u8 as *const libc::c_char);
        } else if last_sibling_12.is_null() {
            last_sibling_12 = ast_add(
                parent_12,
                ast_from_string(basis_ast_4, b"push\0" as *const u8 as *const libc::c_char),
            );
        } else {
        ...
        append_chain = parent_11;
        let mut ele_seq: *mut ast_t = 0 as *mut ast_t;
        let mut basis_ast_5: *mut ast_t = ast;
        let mut parent_13: *mut ast_t = 0 as *mut ast_t;
        let mut last_sibling_13: *mut ast_t = 0 as *mut ast_t;
        let mut node_13: *mut ast_t = 0 as *mut ast_t;
        node_13 = ast_from(basis_ast_5, TK_SEQ);
        ...
        if parent_14.is_null() {
            ...
            last_sibling_14 = ast_add(parent_14, ele_0);
        } else {
            last_sibling_14 = ast_add_sibling(last_sibling_14, ele_0);
        }
        ast_inheritflags(parent_14);
        ele_seq = parent_13;
        let mut append: *mut ast_t = 0 as *mut ast_t;
        let mut basis_ast_6: *mut ast_t = ast;
        let mut parent_15: *mut ast_t = 0 as *mut ast_t;
        let mut last_sibling_15: *mut ast_t = 0 as *mut ast_t;
        let mut node_15: *mut ast_t = 0 as *mut ast_t;
        node_15 = ast_from(basis_ast_6, TK_CALL);
        ...
        if parent_16.is_null() {
            parent_16 = append_chain;
        } else if last_sibling_16.is_null() {
            last_sibling_16 = ast_add(parent_16, append_chain);
        } else {
            last_sibling_16 = ast_add_sibling(last_sibling_16, append_chain);
        }
        node_16 = ast_from(basis_ast_6, TK_POSITIONALARGS);
        if parent_16.is_null() {
            parent_16 = node_16;
        } else if last_sibling_16.is_null() {
        ...
        if parent_17.is_null() {
            ...
            last_sibling_17 = ast_add(parent_17, ele_seq);
        } else {
            last_sibling_17 = ast_add_sibling(last_sibling_17, ele_seq);
        }
        ast_inheritflags(parent_17);
        if parent_16.is_null() {
            parent_16 = ast_from(basis_ast_6, TK_NONE);
        } else if last_sibling_16.is_null() {
            last_sibling_16 = ast_add(parent_16, ast_from(basis_ast_6, TK_NONE));
        } else {
            last_sibling_16 = ast_add_sibling(last_sibling_16, ast_from(basis_ast_6, TK_NONE));
        }
        if parent_16.is_null() {
            parent_16 = ast_from(basis_ast_6, TK_NONE);
        } else if last_sibling_16.is_null() {
        ...
        if !expr_chain(opt, &mut append_chain)
            || !expr_seq(opt, ele_seq)
            || !expr_call(opt, &mut append)
        {
            return 0 as libc::c_int != 0;
        }
        ele_0 = ast_sibling(ele_0);
    }
