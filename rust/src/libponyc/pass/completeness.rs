...
unsafe extern "C" fn completeness_match(mut _opt: *mut pass_opt_t, mut ast: *mut ast_t) -> bool {
    if ast_id(ast) as libc::c_uint == TK_MATCH as libc::c_int as libc::c_uint {
        ...
        ponyint_assert_fail(
            ...
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/pass/completeness.c\0"
                as *const u8 as *const libc::c_char,
            7 as libc::c_int as usize,
            (*::core::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(b"completeness_match\0"))
                .as_ptr(),
        );
    };
...
#[no_mangle]
#[c2rust::src_loc = "40:1"]
pub unsafe extern "C" fn pass_completeness(
    ...
    match ast_id(ast) as libc::c_uint {
        122 => {
            completeness_match(options, ast);
        }
        _ => {}
    }
    AST_OK
