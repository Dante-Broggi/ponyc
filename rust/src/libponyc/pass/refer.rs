...
unsafe extern "C" fn is_assigned_to(mut ast: *mut ast_t, mut check_result_needed: bool) -> bool {
    loop {
        ...
        match ast_id(parent) as libc::c_uint {
            ...
            175 => {
                if ast_childcount(parent) > 1 as libc::c_int as libc::c_ulong {
                    return 0 as libc::c_int != 0;
                }
            }
            178 => {}
