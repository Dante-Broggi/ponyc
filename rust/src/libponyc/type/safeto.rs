...
pub use self::ast_h::{
    ast_child, ast_free_unattached, ast_get_children, ast_id, ast_ptr_t, ast_sibling, ast_type,
};
pub use self::cap_h::{cap_safetomove, cap_single, direction, EXTRACT, WRITE};
...
#[c2rust::src_loc = "6:1"]
unsafe extern "C" fn safe_field_move(
    mut cap: token_id,
    ...
    match ast_id(type_0) as libc::c_uint {
        ...
        17 => {
            let mut upper: *mut ast_t = viewpoint_lower(type_0);
            if upper.is_null() {
                return 0 as libc::c_int != 0;
            }
            let mut ok: bool = safe_field_move(cap, upper, direction);
            if upper != type_0 {
                ast_free_unattached(upper);
            }
            return ok;
        }
        151 | 187 => return cap_safetomove(cap, cap_single(type_0), direction),
        _ => {}
    }
    if 0 as libc::c_int != 0 {
        ...
        ponyint_assert_fail(
            ...
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/type/safeto.c\0" as *const u8
                as *const libc::c_char,
            51 as libc::c_int as size_t,
            (*::core::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"safe_field_move\0"))
                .as_ptr(),
        );
    };
    return 0 as libc::c_int != 0;
...
#[no_mangle]
#[c2rust::src_loc = "55:1"]
pub unsafe extern "C" fn safe_to_move(
    mut ast: *mut ast_t,
    mut type_0: *mut ast_t,
    mut direction: direction,
) -> bool {
    match ast_id(ast) as libc::c_uint {
        84 | 85 | 196 | 87 | 199 => return 1 as libc::c_int != 0,
        195 => return 1 as libc::c_int != 0,
        192 | 193 | 194 => {
            ...
            let mut l_cap: token_id = cap_single(l_type);
            if safe_field_move(l_cap, type_0, direction) {
                return 1 as libc::c_int != 0;
            }
        ...
        178 => {
            if ast_id(type_0) as libc::c_uint == TK_TUPLETYPE as libc::c_int as libc::c_uint {
                ...
                ponyint_assert_fail(
                    ...
                    b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/type/safeto.c\0"
                        as *const u8 as *const libc::c_char,
                    97 as libc::c_int as size_t,
                    (*::core::mem::transmute::<&[u8; 13], &[libc::c_char; 13]>(b"safe_to_move\0"))
                        .as_ptr(),
                );
            };
        ...
        175 => return safe_to_move(ast_child(ast), type_0, direction),
        _ => {}
    }
    if 0 as libc::c_int != 0 {
    } else {
        ponyint_assert_fail(
            ...
            b"/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/type/safeto.c\0" as *const u8
                as *const libc::c_char,
            125 as libc::c_int as size_t,
            (*::core::mem::transmute::<&[u8; 13], &[libc::c_char; 13]>(b"safe_to_move\0")).as_ptr(),
        );
    };
    return 0 as libc::c_int != 0;
}
...
pub unsafe extern "C" fn safe_to_autorecover(
    mut receiver_type: *mut ast_t,
    mut type_0: *mut ast_t,
    mut direction: direction,
) -> bool {
    match ast_id(receiver_type) as libc::c_uint {
        56 => {
            let mut child: *mut ast_t = ast_child(receiver_type);
            while !child.is_null() {
                if safe_to_autorecover(child, type_0, direction) {
                    return 1 as libc::c_int != 0;
                }
                child = ast_sibling(child);
            }
        ...
        149 => {
            let mut child_0: *mut ast_t = ast_child(receiver_type);
            while !child_0.is_null() {
                if !safe_to_autorecover(child_0, type_0, direction) {
                    return 0 as libc::c_int != 0;
                }
        ...
        151 | 187 => return safe_field_move(cap_single(receiver_type), type_0, direction),
        17 => {
            let mut upper: *mut ast_t = viewpoint_upper(receiver_type);
            if upper.is_null() {
                return 0 as libc::c_int != 0;
            }
            let mut ok: bool = safe_to_autorecover(upper, type_0, direction);
    ...
    if 0 as libc::c_int != 0 {
        ...
        ponyint_assert_fail(
            ...
            (*::core::mem::transmute::<&[u8; 20], &[libc::c_char; 20]>(b"safe_to_autorecover\0"))
                .as_ptr(),
        );
    };
    return 0 as libc::c_int != 0;
