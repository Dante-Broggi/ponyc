...
#[c2rust::header_src = "/Users/dantebroggi/Documents/GitHub/ponyc/src/libponyc/type/cap.h:1"]
pub mod cap_h {
    #[c2rust::src_loc = "76:9"]
    ...
    pub type cap_mutation = unsafe extern "C" fn(*mut token_id, *mut token_id) -> bool;
    use super::token_h::token_id;
}
...
pub use self::ast_h::{
    ast_add, ast_add_sibling, ast_append, ast_child, ast_childidx, ast_dup, ast_from,
...
#[no_mangle]
#[c2rust::src_loc = "9:1"]
pub unsafe extern "C" fn cap_aliasing(mut cap: *mut token_id, mut eph: *mut token_id) {
    match *eph as libc::c_uint {
        57 => match *cap as libc::c_uint {
            91 | 92 | 98 | 101 => {}
            _ => {
                *eph = TK_NONE;
            }
...
#[no_mangle]
#[c2rust::src_loc = "61:1"]
pub unsafe extern "C" fn is_cap_sub_cap(
    mut sub: token_id,
    mut subalias: token_id,
    mut super_0: token_id,
    mut supalias: token_id,
) -> bool {
    cap_aliasing(&mut sub, &mut subalias);
    cap_aliasing(&mut super_0, &mut supalias);
    if supalias as libc::c_uint == TK_EPHEMERAL as libc::c_int as libc::c_uint {
        if subalias as libc::c_uint != TK_EPHEMERAL as libc::c_int as libc::c_uint {
            return 0 as libc::c_int != 0;
        }
    }
    if super_0 as libc::c_uint == TK_TAG as libc::c_int as libc::c_uint {
        return 1 as libc::c_int != 0;
    }
    if subalias as libc::c_uint == TK_EPHEMERAL as libc::c_int as libc::c_uint {
        match sub as libc::c_uint {
            91 => return 1 as libc::c_int != 0,
            92 => 's_76: {
                match super_0 as libc::c_uint {
                    99 => {}
                    92 | 93 | 94 | 95 | 97 | 100 => {}
                    91 | 98 | 101 => return 0 as libc::c_int != 0,
                    _ => {
    ...
    match sub as libc::c_uint {
        91 => return super_0 as libc::c_uint == TK_ISO as libc::c_int as libc::c_uint,
        92 => match super_0 as libc::c_uint {
            92 | 95 => return 1 as libc::c_int != 0,
            _ => {}
        },
        93 => match super_0 as libc::c_uint {
            93 | 95 => return 1 as libc::c_int != 0,
            _ => {}
        },
        94 => match super_0 as libc::c_uint {
            94 | 95 | 99 => return 1 as libc::c_int != 0,
            _ => {}
        },
        95 | 97 => match super_0 as libc::c_uint {
            95 => return 1 as libc::c_int != 0,
            _ => {}
        },
        _ => {}
    }
...
pub unsafe extern "C" fn is_cap_sub_cap_constraint(
    mut sub: token_id,
    mut subalias: token_id,
    mut super_0: token_id,
    mut supalias: token_id,
    ...
    if sub as libc::c_uint == super_0 as libc::c_uint
        || super_0 as libc::c_uint == TK_CAP_ANY as libc::c_int as libc::c_uint
    {
        return 1 as libc::c_int != 0;
    }
    match super_0 as libc::c_uint {
        97 => match sub as libc::c_uint {
            93 | 94 | 95 => return 1 as libc::c_int != 0,
            _ => {}
        },
        99 => match sub as libc::c_uint {
            94 | 96 => return 1 as libc::c_int != 0,
            _ => {}
        },
        98 => match sub as libc::c_uint {
            91 | 94 | 96 | 99 => return 1 as libc::c_int != 0,
            _ => {}
        },
        100 => match sub as libc::c_uint {
            93 | 94 | 95 | 96 | 97 | 99 => return 1 as libc::c_int != 0,
            _ => {}
        },
        _ => {}
    }
...
pub unsafe extern "C" fn is_cap_sub_cap_bound(
    mut sub: token_id,
    mut subalias: token_id,
    mut super_0: token_id,
    mut supalias: token_id,
    ...
    if sub as libc::c_uint == super_0 as libc::c_uint
        || super_0 as libc::c_uint == TK_TAG as libc::c_int as libc::c_uint
    {
        return 1 as libc::c_int != 0;
    }
    if subalias as libc::c_uint == TK_EPHEMERAL as libc::c_int as libc::c_uint {
    ...
    match sub as libc::c_uint {
        ...
        94 => match super_0 as libc::c_uint {
            95 | 99 => return 1 as libc::c_int != 0,
            _ => {}
        },
        97 => match super_0 as libc::c_uint {
            95 | 99 | 100 => return 1 as libc::c_int != 0,
            _ => {}
        },
        98 => 's_227: {
            ...
            match super_0 as libc::c_uint {
                99 => {
                    current_block_31 = 9359197607285480129;
                }
                100 => {
                    current_block_31 = 9359197607285480129;
                }
                97 | 101 => {
                    current_block_31 = 11351517610271730030;
                }
                _ => {
                    break 's_227;
                }
        ...
        100 => match super_0 as libc::c_uint {
            97 | 99 => return 1 as libc::c_int != 0,
            _ => {}
        },
        101 => 's_279: {
            ...
            match super_0 as libc::c_uint {
                99 => {
                    current_block_37 = 6402039790748184936;
                }
                98 => {
                    current_block_37 = 6402039790748184936;
                }
                97 | 100 => {
                    current_block_37 = 13637456622240687996;
                }
                _ => {
                    break 's_279;
                }
...
pub unsafe extern "C" fn is_cap_compat_cap(
    mut left_cap: token_id,
    mut left_eph: token_id,
    mut right_cap: token_id,
    mut right_eph: token_id,
) -> bool {
    cap_aliasing(&mut left_cap, &mut left_eph);
    cap_aliasing(&mut right_cap, &mut right_eph);
    if left_cap as libc::c_uint == TK_TAG as libc::c_int as libc::c_uint
        || right_cap as libc::c_uint == TK_TAG as libc::c_int as libc::c_uint
    {
        return 1 as libc::c_int != 0;
    }
    match left_cap as libc::c_uint {
        101 => match right_cap as libc::c_uint {
            101 => {
                return left_eph as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint
                    && right_eph as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint;
            }
            100 => return 1 as libc::c_int != 0,
            _ => {}
        },
        91 => match right_cap as libc::c_uint {
            91 => {
                return left_eph as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint
                    && right_eph as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint;
            }
        ...
        92 => match right_cap as libc::c_uint {
            92 => {
                return left_eph as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint
                    && right_eph as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint;
            }
        ...
        93 => match right_cap as libc::c_uint {
            93 | 95 => return 1 as libc::c_int != 0,
            _ => {}
        },
        94 => match right_cap as libc::c_uint {
            94 | 95 | 99 => return 1 as libc::c_int != 0,
            _ => {}
        },
        95 => match right_cap as libc::c_uint {
            92 | 93 | 94 | 95 | 97 | 99 | 100 => return 1 as libc::c_int != 0,
            _ => {}
        },
        97 => match right_cap as libc::c_uint {
            97 | 95 => return 1 as libc::c_int != 0,
            _ => {}
        },
        100 => match right_cap as libc::c_uint {
            101 | 100 | 95 => return 1 as libc::c_int != 0,
            _ => {}
        },
        99 => match right_cap as libc::c_uint {
            94 | 95 | 99 => return 1 as libc::c_int != 0,
            _ => {}
        },
        98 | _ => {}
...
pub unsafe extern "C" fn cap_single(mut type_0: *mut ast_t) -> token_id {
...
pub unsafe extern "C" fn cap_dispatch(mut type_0: *mut ast_t) -> token_id {
    match ast_id(type_0) as libc::c_uint {
        149 => {
            let mut child: *mut ast_t = ast_child(type_0);
            let mut cap: token_id = cap_dispatch(child);
            child = ast_sibling(child);
            while !child.is_null() {
                let mut child_cap: token_id = cap_dispatch(child);
        ...
        56 => {
            ...
            let mut cap_0: token_id = cap_dispatch(child_0);
            child_0 = ast_sibling(child_0);
            while !child_0.is_null() {
                let mut child_cap_0: token_id = cap_dispatch(child_0);
                if is_cap_sub_cap(child_cap_0, TK_NONE, cap_0, TK_NONE) {
                    cap_0 = child_cap_0;
                }
                child_0 = ast_sibling(child_0);
            }
...
pub unsafe extern "C" fn cap_for_this(mut t: *mut typecheck_t) -> token_id {
    if ast_id((*(*t).frame).type_0) as libc::c_uint == TK_PRIMITIVE as libc::c_int as libc::c_uint {
        return TK_VAL;
    }
    if ((*(*t).frame).method).is_null() {
        return TK_REF;
    }
...
pub unsafe extern "C" fn cap_view_upper(
    mut left_cap: token_id,
    mut left_eph: token_id,
    mut right_cap: *mut token_id,
    mut right_eph: *mut token_id,
) -> bool {
    cap_aliasing(&mut left_cap, &mut left_eph);
    cap_aliasing(right_cap, right_eph);
    match left_cap as libc::c_uint {
        96 | 98 | 99 | 100 | 101 => return 0 as libc::c_int != 0,
        _ => {}
    }
    if *right_cap as libc::c_uint == TK_TAG as libc::c_int as libc::c_uint {
        return 1 as libc::c_int != 0;
    }
    match left_cap as libc::c_uint {
        91 => match *right_cap as libc::c_uint {
            91 | 98 => {
                if left_eph as libc::c_uint == TK_EPHEMERAL as libc::c_int as libc::c_uint {
        ...
        93 => {}
        94 => {
            match *right_cap as libc::c_uint {
                98 | 99 | 100 | 101 => {
...
pub unsafe extern "C" fn cap_view_lower(
    mut left_cap: token_id,
    mut left_eph: token_id,
    mut right_cap: *mut token_id,
    mut right_eph: *mut token_id,
...
pub unsafe extern "C" fn cap_safetomove(
    mut into: token_id,
    mut cap: token_id,
    mut direction: direction,
) -> bool {
    match into as libc::c_uint {
        91 => match cap as libc::c_uint {
            91 | 94 | 96 | 98 | 99 => return 1 as libc::c_int != 0,
            _ => {}
        },
        92 | 94 => match cap as libc::c_uint {
            91 | 94 | 96 | 98 | 99 => return 1 as libc::c_int != 0,
            92 => {
                return direction as libc::c_uint == WRITE as libc::c_int as libc::c_uint;
            }
            95 => {
                return direction as libc::c_uint == EXTRACT as libc::c_int as libc::c_uint;
            }
            _ => {}
        },
...
pub unsafe extern "C" fn cap_sendable(mut cap: token_id) -> bool {
    match cap as libc::c_uint {
        91 | 94 | 96 | 98 | 99 => return 1 as libc::c_int != 0,
        _ => {}
    }
...
pub unsafe extern "C" fn cap_immutable_or_opaque(mut cap: token_id) -> bool {
    match cap as libc::c_uint {
        94 | 95 | 96 | 99 => return 1 as libc::c_int != 0,
        _ => {}
    }
    return 0 as libc::c_int != 0;
}
#[c2rust::src_loc = "1018:1"]
unsafe extern "C" fn modified_cap_single(
    mut type_0: *mut ast_t,
    mut mutation: Option<cap_mutation>,
) -> *mut ast_t {
    let mut cap: *mut ast_t = cap_fetch(type_0);
    let mut ephemeral: *mut ast_t = ast_sibling(cap);
    let mut cap_token: token_id = ast_id(cap);
    let mut eph_token: token_id = ast_id(ephemeral);
    if mutation.expect("non-null function pointer")(&mut cap_token, &mut eph_token) {
...
pub unsafe extern "C" fn modified_cap(
    mut type_0: *mut ast_t,
    mut mutation: Option<cap_mutation>,
) -> *mut ast_t {
    let mut id: token_id = ast_id(type_0);
    match id as libc::c_uint {
        ...
        151 | 187 => return modified_cap_single(type_0, mutation),
        17 => {
            ...
            let mut new_right: *mut ast_t = modified_cap(right, mutation);
            if new_left != left || new_right != right {
                ...
                if parent_0.is_null() {
                    ...
                    last_sibling_0 = ast_add(parent_0, new_left);
                } else {
                    last_sibling_0 = ast_add_sibling(last_sibling_0, new_left);
                }
                if parent_0.is_null() {
                    parent_0 = new_right;
                } else if last_sibling_0.is_null() {
                    last_sibling_0 = ast_add(parent_0, new_right);
                } else {
                    last_sibling_0 = ast_add_sibling(last_sibling_0, new_right);
                }
        ...
        91 | 92 | 94 | 93 | 95 | 96 => {
            let mut cap: token_id = id;
            let mut eph: token_id = TK_NONE;
            if mutation.expect("non-null function pointer")(&mut cap, &mut eph) {
                if eph as libc::c_uint == TK_NONE as libc::c_int as libc::c_uint {
                } else {
                    ponyint_assert_fail(
...
pub unsafe extern "C" fn unisolated_mod(mut cap: *mut token_id, mut eph: *mut token_id) -> bool {
    if *eph as libc::c_uint == TK_EPHEMERAL as libc::c_int as libc::c_uint {
        return 0 as libc::c_int != 0;
    }
    match *cap as libc::c_uint {
        91 | 92 => {
