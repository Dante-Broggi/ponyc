...
#[c2rust::src_loc = "86:1"]
unsafe extern "C" fn flag_hash(mut flag: *mut flag_t) -> size_t {
    if !flag.is_null() {
    } else {
        ponyint_assert_fail(
...
unsafe extern "C" fn flag_dup(mut flag: *mut flag_t) -> *mut flag_t {
    ...
    let mut f: *mut flag_t = ponyint_pool_alloc(0 as libc::c_int as size_t) as *mut flag_t;
    memcpy(
...
unsafe extern "C" fn flag_free(mut flag: *mut flag_t) {
    ...
    ponyint_pool_free(0 as libc::c_int as size_t, flag as *mut libc::c_void);
}
#[no_mangle]
#[c2rust::src_loc = "116:1"]
pub unsafe extern "C" fn flagtab_size(mut map: *mut flagtab_t) -> size_t {
...
#[no_mangle]
#[c2rust::src_loc = "116:1"]
pub unsafe extern "C" fn flagtab_removeindex(mut map: *mut flagtab_t, mut index: size_t) {
    ponyint_hashmap_removeindex(map as *mut hashmap_t, index);
}
#[no_mangle]
#[c2rust::src_loc = "116:1"]
pub unsafe extern "C" fn flagtab_clearindex(mut map: *mut flagtab_t, mut index: size_t) {
    ponyint_hashmap_clearindex(map as *mut hashmap_t, index);
}
#[no_mangle]
#[c2rust::src_loc = "116:1"]
pub unsafe extern "C" fn flagtab_init(mut map: *mut flagtab_t, mut size: size_t) {
...
pub unsafe extern "C" fn buildflagset_create() -> *mut buildflagset_t {
    let mut p: *mut buildflagset_t =
        ponyint_pool_alloc(1 as libc::c_int as size_t) as *mut buildflagset_t;
    if !p.is_null() {
    } else {
        ponyint_assert_fail(
    ...
    *fresh0 = ponyint_pool_alloc(0 as libc::c_int as size_t) as *mut flagtab_t;
    flagtab_init((*p).flags, 8 as libc::c_int as size_t);
    let ref mut fresh1 = (*p).text_buffer;
    *fresh1 = 0 as *mut libc::c_char;
    (*p).buffer_size = 0 as libc::c_int as size_t;
    return p;
}
#[no_mangle]
...
pub unsafe extern "C" fn buildflagset_free(mut set: *mut buildflagset_t) {
    if !set.is_null() {
        ...
        ponyint_pool_free(1 as libc::c_int as size_t, set as *mut libc::c_void);
    }
}
...
pub unsafe extern "C" fn buildflagset_get(
    ...
    let mut h_index: size_t = -(1 as libc::c_int) as size_t;
...
pub unsafe extern "C" fn buildflagset_print(mut set: *mut buildflagset_t) -> *const libc::c_char {
    ...
    let mut size_needed: size_t = (p.offset_from((*set).text_buffer) as libc::c_long
...
pub unsafe extern "C" fn clear_build_flags() {
    if !_user_flags.is_null() {
        ...
        ponyint_pool_free(0 as libc::c_int as size_t, _user_flags as *mut libc::c_void);
