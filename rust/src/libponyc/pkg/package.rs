...
pub mod program_h {
    ...
    extern "C" {
        #[c2rust::src_loc = "20:1"]
        pub fn program_assign_pkg_id(ast: *mut ast_t) -> uint32_t;
    }
}
...
pub unsafe extern "C" fn package_group_list_pony_type() -> *const pony_type_t {
    return &package_group_list_pony;
}
#[c2rust::src_loc = "92:1"]
static mut package_group_list_pony: pony_type_t = unsafe {
    {
        let mut init = _pony_type_t {
            ...
            size: ::core::mem::size_of::<package_group_list_t>() as libc::c_ulong as uint32_t,
...
pub unsafe extern "C" fn package_group_list_index(
    ...
    return ponyint_list_index(list as *mut list_t, index) as *mut package_group_list_t;
}
#[no_mangle]
#[c2rust::src_loc = "92:43"]
...
pub unsafe extern "C" fn package_group_list_reverse(
    ...
    return ponyint_list_reverse(list as *mut list_t) as *mut package_group_list_t;
}
#[no_mangle]
#[c2rust::src_loc = "92:43"]
pub unsafe extern "C" fn package_group_list_next(
    ...
    return ponyint_list_next(list as *mut list_t) as *mut package_group_list_t;
}
#[no_mangle]
#[c2rust::src_loc = "92:43"]
pub unsafe extern "C" fn package_group_list_append(
    ...
    return ponyint_list_append(list as *mut list_t, data as *mut libc::c_void)
        as *mut package_group_list_t;
}
#[no_mangle]
#[c2rust::src_loc = "92:43"]
pub unsafe extern "C" fn package_group_list_push(
    ...
    return ponyint_list_push(list as *mut list_t, data as *mut libc::c_void)
        as *mut package_group_list_t;
}
#[no_mangle]
#[c2rust::src_loc = "92:43"]
pub unsafe extern "C" fn package_group_list_pop(
    ...
    return ponyint_list_pop(list as *mut list_t, data as *mut *mut libc::c_void)
        as *mut package_group_list_t;
}
#[no_mangle]
...
pub unsafe extern "C" fn package_group_list_data(
    ...
    return ponyint_list_data(list as *mut list_t) as *mut package_group_t;
}
#[c2rust::src_loc = "96:1"]
...
static mut package_set_pony: pony_type_t = unsafe {
    {
        let mut init = _pony_type_t {
            id: 0 as libc::c_int as uint32_t,
            size: ::core::mem::size_of::<package_set_t>() as libc::c_ulong as uint32_t,
            field_count: 0 as libc::c_int as uint32_t,
            field_offset: 0 as libc::c_int as uint32_t,
            instance: 0 as *const libc::c_void as *mut libc::c_void,
            trace: None,
...
unsafe extern "C" fn parse_files_in_dir(
    ...
    let mut err: uint32_t = 0 as libc::c_int as uint32_t;
...
pub unsafe extern "C" fn create_package(
    ...
    let mut pkg_id: uint32_t = program_assign_pkg_id(program);
...
pub unsafe extern "C" fn package_load(
    ...
    if !ast_passes_subtree(&mut package, opt, (*opt).program_pass) {
        ast_setflag(package, AST_FLAG_PRESERVE as libc::c_int as uint32_t);
        return 0 as *mut ast_t;
    }
    return package;
}
...
static mut package_dep_signature_pony: pony_type_t = unsafe {
    {
        let mut init = _pony_type_t {
            id: 0 as libc::c_int as uint32_t,
            size: ::core::mem::size_of::<package_signature_t>() as libc::c_ulong as uint32_t,
            field_count: 0 as libc::c_int as uint32_t,
            field_offset: 0 as libc::c_int as uint32_t,
            instance: 0 as *const libc::c_void as *mut libc::c_void,
            trace: None,
...
static mut package_group_dep_signature_pony: pony_type_t = unsafe {
    {
        let mut init = _pony_type_t {
            id: 0 as libc::c_int as uint32_t,
            size: ::core::mem::size_of::<*const libc::c_char>() as libc::c_ulong as uint32_t,
            field_count: 0 as libc::c_int as uint32_t,
            field_offset: 0 as libc::c_int as uint32_t,
            instance: 0 as *const libc::c_void as *mut libc::c_void,
            trace: None,
...
static mut package_pony: pony_type_t = unsafe {
    {
        let mut init = _pony_type_t {
            id: 0 as libc::c_int as uint32_t,
            size: ::core::mem::size_of::<package_t>() as libc::c_ulong as uint32_t,
            field_count: 0 as libc::c_int as uint32_t,
            field_offset: 0 as libc::c_int as uint32_t,
            instance: 0 as *const libc::c_void as *mut libc::c_void,
            trace: None,
...
unsafe extern "C" fn package_group_serialise(
    ...
    *fresh54 = ptr_offset as *mut libc::c_char;
    ...
    package_set_serialise(
        ...
        &mut (*group).members as *mut package_set_t as *mut libc::c_void,
        buf,
        offset.wrapping_add(8 as libc::c_ulong),
        PONY_TRACE_MUTABLE as libc::c_int,
    );
}
...
static mut package_group_pony: pony_type_t = unsafe {
    {
        let mut init = _pony_type_t {
            id: 0 as libc::c_int as uint32_t,
            size: ::core::mem::size_of::<package_group_t>() as libc::c_ulong as uint32_t,
            field_count: 0 as libc::c_int as uint32_t,
            field_offset: 0 as libc::c_int as uint32_t,
            instance: 0 as *const libc::c_void as *mut libc::c_void,
            trace: None,
